...
<div class="row">
    <div class="widget-box hidden-boder" id="reloadReport">
        <div class="widget-header widget-header-blue widget-header-flat" style="display:none;">
            <h4 class="widget-title lighter"><strong> Report </strong></h4>
                    ...
                    <div class="col-xs-12 widthTable">
                        <form class="form-horizontal" id="frmSearch">
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-1 control-label "><strong>Type : </strong></label>
                                <div class="col-xs-6 col-sm-2">
                                    <select class="form-control col-xs-12 col-sm-6" id="stype" name="stype">
                        ...
                        <div class="table-header">
                            Results for Report " <font color="black"><sapn class="showsdate">03-07-2019</sapn></font> "
                        </div>
                            ...
                            <table id="tbReport" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" id="thWaitChecking">Wait Checking</th>
                                        <th class="text-center" id="thWaitCredit">Wait Add Credit</th>
                                        <th class="text-center">Add Credit Success</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td colspan="7"><center><strong> no data</strong></center></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td align="center" colspan="4"><strong>Net</strong></td>
